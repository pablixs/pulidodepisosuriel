...
const INSTAGRAM_URL = "https://www.instagram.com/insaurraldeflooring/";
...
export default function WhatsappBtn() {
  ...
  return (
    <>
      ...
      >
        <span className={styles.buttonLabel}>Seguinos en Instagram</span>
        <span className={`${styles.buttonIcon} ${styles.instagramIcon}`}>
      ...
      <a
        ...
        onClick={handleClick}
      >
        <span className={styles.buttonLabel}>Envianos un mensaje</span>
        <span className={`${styles.buttonIcon} ${styles.whatsappIcon}`}>
